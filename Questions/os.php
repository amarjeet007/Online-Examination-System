...
<form action="os.php" method="post"> 
	 <?php 
		  ...
		  $i=1;
		// $cat_id=$_GET['cat'];
		  $query="select * from question2 where cat_id='os'";
		  ...
		  while($row=mysql_fetch_array($run)){
			  ...
			  <h4><?php echo "<".$i.">"; ?><b><?php echo $ques;?></b></h4>
...
if(isset($_POST['submit'])){
 ...
 $conn=mysql_connect("localhost","root","");
 mysql_select_db("oes");
   $query1="select  * from question2 where cat_id='os'";
  ...
  <div class="progress">
    <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo $marks;?>" aria-valuemin="0" aria-valuemax="<?php echo $total;?>" style="width:$per%">
	  ...
	  $check_result="select * from result where user_email='$email2' AND cat_id='os'";
	...
	$result_query="	UPDATE result  SET cat_id='os',correct_marks='$marks',total_marks='$total',date='$date' WHERE user_email='$email2' AND cat_id='os'";
