...
<form action="cpp2.php" method="post"> 
	 <?php 
 ...
 mysql_select_db("oes");
  ...
  <div class="progress">
	...
	$result_query="	UPDATE result  SET correct_marks='$marks',total_marks='$total',date='$date' WHERE user_email='$email2' AND cat_id='cpp' AND q_set='set-1' ";
	 ...
	 $result_query="insert into result(user_email,cat_id,correct_marks,total_marks,date) values('$email2','$cat1','$marks','$total','$date','set-1')";
